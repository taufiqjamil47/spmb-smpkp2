...
@section('content')
    <div class="div mt-8">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center space-x-4 flex-wrap gap-2">
                    ...
                    <span class="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm">
                        ...
                        Kuota Tersedia: {{ $jumlahPendaftar }} / {{ $kuota }}
                    </span>
                    @if ($jumlahAntrian > 0)
                        <span class="px-3 py-1 bg-yellow-400 bg-opacity-80 rounded-full text-sm">
                            <i class="fas fa-hourglass-half mr-1"></i>
                            Antrian: {{ $jumlahAntrian }} siswa
                        </span>
                    @endif
                </div>
            </div>
        ...
        <!-- Info Box untuk Waiting List -->
        @if ($jumlahPendaftar >= $kuota)
            <div class="mb-8 bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 rounded-xl p-5">
                <div class="flex items-start">
                    ...
                    <div class="ml-3 flex-1">
                        <h3 class="text-lg font-bold text-yellow-800 mb-1">Pendaftaran Melalui Daftar Tunggu</h3>
                        <p class="text-sm text-yellow-700 mb-2">
                            Kuota pendaftaran untuk tahun ajaran {{ $tahunAjaranAktif->tahun_ajaran }} telah penuh.
                            Anda masih dapat mendaftar, namun akan masuk dalam daftar antrian (waiting list).
                        </p>
                        <p class="text-sm text-yellow-700">
                            <strong>Anda akan dipromosikan menjadi pendaftar resmi</strong> ketika ada siswa lain yang
                            mengundurkan diri.
                        </p>
                    </div>
                    <div class="flex items-center space-x-4 flex-wrap gap-2">
                        <span class="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm">
                            ...
                            Sisa Kuota: {{ $jumlahPendaftar }} / {{ $kuota }}
                        </span>
                        @if ($jumlahAntrian < 10)
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <form action="{{ route('pendaftaran.store') }}" method="POST" class="p-6">
                        ...
                        <div class="relative">
                            ...
                            <select name="tahun_lulus"
                                ...
                                @for ($tahun = date('Y'); $tahun >= date('Y') - 5; $tahun--)
                                    <option value="{{ $tahun }}"
                                        {{ old('tahun_lulus', date('Y')) == $tahun ? 'selected' : '' }}>
                                        {{ $tahun }}
                                    </option>
                                @endfor
                            </select>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <i class="fas fa-shirt absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
            ...
            <div class="mb-8">
                ...
                <div class="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl border-l-4 border-yellow-500 p-4 mb-5">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <i class="fas fa-info-circle text-yellow-600 text-lg"></i>
                        </div>
