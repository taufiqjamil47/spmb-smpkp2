...
class CalonSiswaCsvExport implements FromCollection, WithHeadings, WithMapping, WithCustomCsvSettings
{
    ...
    public function headings(): array
    {
        return [
            ...
            'NO_HP_ORTU',
            'TAHUN_AJARAN',
            'GROUPING_REQUEST_CODE',
            'GROUP_NAME',
            'GROUP_STATUS',
            'GROUPING_PRIORITY',
            'REQUESTED_WITH_NAMES',
            'TANGGAL_DAFTAR',
            'STATUS',
            'TANGGAL_DIHAPUS'
        ];
    ...
    public function map($siswa): array
    {
        ...
        return [
            ...
            $siswa->groupingRequest->request_code ?? '-',
            $siswa->groupingRequest->group_name ?? '-',
            ucfirst($siswa->groupingRequest->status ?? '-'),
            ucfirst($siswa->grouping_priority ?? 'none'),
            $siswa->requested_with_names ? str_replace('|', ', ', $siswa->requested_with_names) : '-',
